...
public class HistoryHuoDongNewAdapter extends RecyclerView.Adapter<HistoryHuoDongNewAdapter.ViewHolder> implements View.OnClickListener {
     ...
     * @param DataList
     */
    public HistoryHuoDongNewAdapter(Context mContext, List<ActiviteNewBean.DataBean.ActivityListBean> DataList) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_history_activite, parent, false);
