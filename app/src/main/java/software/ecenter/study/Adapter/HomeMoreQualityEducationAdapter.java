...
public class HomeMoreQualityEducationAdapter extends RecyclerView.Adapter<HomeMoreQualityEducationAdapter.ViewHolder> implements View.OnClickListener {
    private List<HomeMoreQualityEducationBean.DataBean.QualityEducationListBean> DataList;
     ...
     * @param DataList
     */
    public HomeMoreQualityEducationAdapter(Context mContext, List<HomeMoreQualityEducationBean.DataBean.QualityEducationListBean> DataList) {
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        HomeMoreQualityEducationBean.DataBean.QualityEducationListBean bean = DataList.get(position);
