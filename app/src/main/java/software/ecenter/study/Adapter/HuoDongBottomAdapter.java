...
public class HuoDongBottomAdapter extends RecyclerView.Adapter<HuoDongBottomAdapter.ViewHolder> implements View.OnClickListener {
    ...
    static class ViewHolder extends RecyclerView.ViewHolder{
        ...
        public ViewHolder(View itemView) {
            ...
            conext = (TextView) itemView.findViewById(R.id.huodong_conext);
     ...
     * @param DataList
     */
    public HuoDongBottomAdapter(Context mContext, List<ActivityBean> DataList) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.list_item_huodong_bottom,parent,false);
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        holder.conext.setText(bean.getActivityContent());
