 ...
 * Create by 2019/11/8
 */
public class PySpellAdapter extends RecyclerView.Adapter<PySpellAdapter.Holder> {
    private Context mContext;
    private List<PinLishiBean.DataBean.AudioListBean> mList = new ArrayList<>();
    private OnClickItemListener listener;

    public PySpellAdapter(Context mContext, OnClickItemListener listener) {
    ...
    public Holder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View inflate = LayoutInflater.from(mContext).inflate(R.layout.itme_spell, viewGroup, false);
