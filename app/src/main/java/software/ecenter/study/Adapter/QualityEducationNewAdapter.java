...
public class QualityEducationNewAdapter extends RecyclerView.Adapter<QualityEducationNewAdapter.ViewHolder> implements View.OnClickListener {
    private List<HomeNewBean.DataBean.QualityEducationListBean> DataList;
...
//            Name = (TextView) itemView.findViewById(R.id.kecheng_name);
     ...
     * @param DataList
     */
    public QualityEducationNewAdapter(Context mContext, List<HomeNewBean.DataBean.QualityEducationListBean> DataList) {
        this.DataList = DataList;
        this.mContext = mContext;
        imageCacheManager = new ImageCacheManager(mContext, R.drawable.morenshu, true);
    }

    public void refreshData( List<HomeNewBean.DataBean.QualityEducationListBean> DataList) {
        this.DataList = DataList;
...
//        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_class_jaoyu,parent,false);
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        HomeNewBean.DataBean.QualityEducationListBean bean = DataList.get(position);
        if (bean == null) return;
