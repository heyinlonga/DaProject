...
public class SearchTushuAdapter extends RecyclerView.Adapter<SearchTushuAdapter.ViewHolder> implements View.OnClickListener {
    ...
    static class ViewHolder extends RecyclerView.ViewHolder{
        ...
        public ViewHolder(View itemView) {
            super(itemView);
            Image = (ImageView) itemView.findViewById(R.id.search_tushu_image);
            Name = (TextView) itemView.findViewById(R.id.search_tushu_name);
     ...
     * @param DataList
     */
    public SearchTushuAdapter(Context mContext, List<BookBean> DataList) {
        this.DataList = DataList;
        this.mContext = mContext;
        imageCacheManager = new ImageCacheManager(mContext, R.drawable.morenshu, true);
    }

    public void  refreshData(List<BookBean> DataList){
        this.DataList = DataList;
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.search_list_item_tushu,parent,false);
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        BookBean bean = DataList.get(position);
