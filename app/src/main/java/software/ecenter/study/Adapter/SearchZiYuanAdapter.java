...
public class SearchZiYuanAdapter extends RecyclerView.Adapter<SearchZiYuanAdapter.ViewHolder> implements View.OnClickListener {
    ...
    static class ViewHolder extends RecyclerView.ViewHolder{
        ...
        public ViewHolder(View itemView) {
            super(itemView);
            Name = (TextView) itemView.findViewById(R.id.search_ziyuan_name);
     ...
     * @param DataList
     */
    public SearchZiYuanAdapter(Context mContext, List<ResourceBean> DataList) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.search_list_item_ziyuan,parent,false);
