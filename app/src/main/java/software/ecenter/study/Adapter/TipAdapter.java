...
public class TipAdapter extends RecyclerView.Adapter<TipAdapter.ViewHolder> implements View.OnClickListener{
     ...
     * @param DataList
     */
    public TipAdapter(Context mContext, List<BaseBean> DataList) {
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        BaseBean bean = DataList.get(position);
