...
public class TipKechengAdapter extends RecyclerView.Adapter<TipKechengAdapter.ViewHolder> implements View.OnClickListener{
     ...
     * @param DataList
     */
    public TipKechengAdapter(Context mContext, List<CurriculumBean> DataList) {
