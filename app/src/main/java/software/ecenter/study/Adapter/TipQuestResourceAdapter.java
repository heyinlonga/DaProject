...
public class TipQuestResourceAdapter extends RecyclerView.Adapter<TipQuestResourceAdapter.ViewHolder> implements View.OnClickListener {
    private List<QuestionListBean> DataList;
     ...
     * @param DataList
     */
    public TipQuestResourceAdapter(Context mContext, List<QuestionListBean> DataList) {
        this.DataList = DataList;
        this.mContext = mContext;

    }

    public void refreshData(List<QuestionListBean> DataList) {
        this.DataList = DataList;
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        QuestionListBean bean = DataList.get(position);
        if (TextUtils.isEmpty(bean.getQuestionName())) {
            holder.Name.setText("");
        } else {
