...
public class TipTeacherResourceAdapter extends RecyclerView.Adapter<TipTeacherResourceAdapter.ViewHolder> implements View.OnClickListener {
    private List<SeeTeacherResBean.DataBean.ResourceListBean> DataList = new ArrayList<>();
     ...
     * @param
     */
    public TipTeacherResourceAdapter(List<SeeTeacherResBean.DataBean.ResourceListBean> list) {
        DataList.clear();
    ...
    public void refreshData(List<SeeTeacherResBean.DataBean.ResourceListBean> list) {
        DataList.clear();
        if (list != null && list.size() > 0) {
            DataList.addAll(list);
        }
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        SeeTeacherResBean.DataBean.ResourceListBean bean = DataList.get(position);
