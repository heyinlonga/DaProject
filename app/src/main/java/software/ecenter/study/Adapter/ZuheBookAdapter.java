...
public class ZuheBookAdapter extends RecyclerView.Adapter<ZuheBookAdapter.ViewHolder> implements View.OnClickListener{
    private List<ZuheBookBean> DataList;
    ...
    static class ViewHolder extends RecyclerView.ViewHolder{
        ...
        public ViewHolder(View itemView) {
            super(itemView);
            Image = (ImageView) itemView.findViewById(R.id.zuhe_book_image);
            Name = (TextView) itemView.findViewById(R.id.zuhe_book_name);
     ...
     * @param DataList
     */
    public ZuheBookAdapter(Context mContext, List<ZuheBookBean> DataList) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.list_zuhe_book_item,parent,false);
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        ZuheBookBean bean = DataList.get(position);
