...
public class ExpandableTextView extends LinearLayout {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        duration=array.getInteger(R.styleable.ExpandableTextViewAttr_duration, 10);
        array.recycle();
    }
    ...
    protected void onFinishInflate() {
        ...
        id_expand_textview.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (isCollapsed) {
                    id_expand_textview.setText("查看全部");
                    setTextImg(R.drawable.tzhankai);
                    if (listener!=null) {
...
//                requestLayout();
    ...
    private void setTextImg(int resId){
        Drawable drawable = context.getResources().getDrawable(resId);
        drawable.setBounds(0,0,drawable.getMinimumWidth(),drawable.getMinimumHeight());
        id_expand_textview.setCompoundDrawables(null,null,drawable,null);
        id_expand_textview.setCompoundDrawablePadding(ScreenUtil.dip2px(context,5));
    }
    @Override
