...
public class LoadingDialog {
	...
	public LoadingDialog(Context context) {
		...
		contentView = inflater.inflate(R.layout.loadingdialog, null);
		...
		rotate = new RotateAnimation(0f, 180000f, Animation.RELATIVE_TO_SELF, 0.5f, Animation.RELATIVE_TO_SELF, 0.5f);
