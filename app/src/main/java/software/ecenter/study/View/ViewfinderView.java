...
public class ViewfinderView extends View {
    protected static final String TAG = com.journeyapps.barcodescanner.ViewfinderView.class.getSimpleName();
    ...
    public ViewfinderView(Context context, AttributeSet attrs) {
        ...
        linePaint.setColor(Color.parseColor("#FF203E"));
        linePaint.setStrokeWidth(3);
        lineSize = ScreenUtil.dip2px(context,30);
...
//        Rect frame = framingRect;
        ...
        int size = 110;
        Rect frame = new Rect(framingRect.left+size,framingRect.top+size,framingRect.right-size,framingRect.bottom-size);
