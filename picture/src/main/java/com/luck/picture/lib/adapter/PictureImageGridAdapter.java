...
//                        .apply(options)
    ...
    private void changeCheckboxState(ViewHolder contentHolder, LocalMedia image) {
        ...
        if (selectImages.size() >= maxSelectNum && !isChecked) {
            ...
            String str = eqImg ? context.getString(R.string.picture_message_max_num, config.maxSelectNum)
                    : context.getString(R.string.picture_message_video_max_num, config.maxSelectNum);
